// Bai1_Lab3.cpp : Defines the entry point for the console application.
//
...
{                               // vsync = 1 nếu muốn sử dụng V-Sync     
	...
	wnd = SDL_CreateWindow("FPS", 100, 100, WWIDTH, WHEIGHT, SDL_WINDOW_SHOWN);     // tạo đối tượng dựng hình 2D, kiểm tra việc kích hoạt V-Sync     
