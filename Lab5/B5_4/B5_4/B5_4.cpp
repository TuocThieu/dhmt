// B5_4.cpp : Defines the entry point for the console application.
//
#include "glew.h"
#include "glut.h"
#include <stdio.h>
...
vec3  shade = { 1.0, 1.0, 1.0 };          /* gai tri mau cua van nhieu */
...
float Ka = 0.1f;                     /* he so ambient */
float Kd = 1.0f;                     /* he so diffuse */
float Ks = 1.0f;                     /* he so specular */
float shininess = 32.0f;                    /* he so bong be mat */
vec3 camera = { 0.0f, 0.0f, 5.0f };       /* vi tri camera */
