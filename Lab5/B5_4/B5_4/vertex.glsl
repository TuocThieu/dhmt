...
uniform float time;         // tri thoi gian bien doi nhieu 
uniform float displacement; // do manh cua hieu ung 
varying float noise;        // gia tri mau cho cho fragment shader 
const float speed = 1.0;    // toc do hoat canh 
const float scale = 2.0;    // ty le van nhieu
